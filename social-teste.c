...
int verifica_st_remove(estrutura *st)
{
    ...
    {   
       ...
       if((i==1) && (strcmp(amigo,"TERESA")==0))
        {
            printf("...verifica_st_remove(): st_remove removeu a amiga TERESA com 1 mensagens (OK)\n");
        
        }
        else
           { 
            printf("...verifica_st_remove():  st_remove não removeu a amiga TERESA com 1 mensagens (ERRO)\n,mas sim a %s com %d mensagens",amigo,i);
            er++;
           }
    }
     el=st_remove(st,"PEDRO");
    ...
    {   
        i=0;
        if (strcmp(el->msg->remetente,"PEDRO")==0)
            strcpy(amigo,el->msg->destinatario);
       ...
       if((i==4) && (strcmp(amigo,"SUSANA")==0))
        {
            printf("...verifica_st_remove(): st_remove removeu a amiga SUSANA com 4 mensagens (OK)\n");
        
        }
        else
           { 
            printf("...verifica_st_remove():  st_remove não removeu a amiga SUSANA com 4 mensagens (ERRO)\n,mas sim a %s com %d mensagens",amigo,i);
            er++;
           }
    }
    el=st_remove(st,"PEDRO");
